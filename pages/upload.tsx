                ...
                {videoAsset ? (
                  ...
                  <label className="cursor-pointer">
                    <div className="flex flex-col
                      ...
                      <p className="bg-[#EC5578] text-center mt-10 rounded text-white text-md font-medium p-2 w-52 outline-none">
                        Select File
                      </p>
                    </div>
                    <input
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          <div className="flex gap-6 mt-10">
              ...
              <button
                onClick={handlePost}
                type="button"
                className="bg-[#EC5578] text-white text-md font-medium p-2 rounded w-28 lg:w-44 outline-none"
                >
                  Post
              </button>
          </div>
