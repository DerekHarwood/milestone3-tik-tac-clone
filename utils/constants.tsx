...
import { FaPaw, FaMedal, FaGamepad, FaSuitcase } from 'react-icons/fa';
...
export const footerList2 = [ 'TikTac for Good','Advertise','Developers','Transparency','TikTac Rewards' ]
